...
static void InstanceCommand( ABP_MsgType* psNewMessage )
{
   ...
   case ABP_CMD_GET_ATTR:
   {
      ...
      default:
      {
         ...
         */
         ...
         bHighestAttribute = ( ( iNumAdisInMap / iAdisPerAttribute ) + ABP_ASM_IA_ADI_MAP_XX );
   ...
   case ABP_CMD_SET_ATTR:
   {
      ...
      default:
      {
         ...
         bHighestAttribute = ( ( ASM_MAX_ADI_MAPS_PER_INSTANCE / iAdisPerAttribute ) + ABP_ASM_IA_ADI_MAP_XX );
